...
class BaseExperiment(ABC):
    ...
    def exec_task(self, task: str, *args, **kwargs) -> None:
        """
...
class BaseLightningExperiment(BaseExperiment):
    ...
    def training(self) -> None:
        ...
        try:
            train_data_stats = {"Mean": self.train_dataset.Mean, "Std": self.train_dataset.Std, "ActionMean": self.train_dataset.ActionMean, "ActionStd": self.train_dataset.ActionStd}
    ...
    def test(self) -> None:
        ...
        trainer = pl.Trainer(
            ...
            detect_anomaly=True,  # self.cfg.debug,
        )
